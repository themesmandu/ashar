		...
		<main id="main" class="col-lg-12">
			...
			<section class="error-404 not-found">
				...
				<div class="page-content">
					...
					$ashar_archive_content = '<p>' . sprintf( esc_html__( 'Try looking in the monthly archives. %1$s', 'ashar' ), convert_smilies( ':)' ) ) . '</p>';
					the_widget( 'WP_Widget_Archives', 'dropdown=1', "after_title=</h2>$ashar_archive_content" );
