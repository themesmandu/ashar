...
if ( ! function_exists( 'ashar_setup' ) ) :
	...
	function ashar_setup() {
		...
		add_theme_support( 'custom-background', apply_filters( 'ashar_custom_background_args', array(
...
function ashar_scripts() {
	wp_enqueue_style( 'ashar-style', get_stylesheet_uri() );

	wp_enqueue_script( 'ashar-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'ashar-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
